...
import (
	"errors"
	"github.com/KarlvenK/korm/clause"
	"reflect"
)

//Insert one or more reocrds in database
...
遍历每一行记录，利用反射创建 destType 的实例 dest，将 dest 的
所有字段平铺开，构造切片 values。
